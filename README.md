...
You are looking at my personal branch of this repo. This is where I store my personal configuration. It might get updated more frequently or reflect a newer version 
of XCSoar.
...
This configuration will likely work with a variety of hardware and software versions of XCSoar. It was initially developed on 
a **Kobo Mini running XCSoar 6.8.16** but was most recently installed on the same hardware running 
**XCSoar 7.23**.

In the past, it was observed to be working on an Android phone running XCSoar version **6.8.16-Android dated Jul 26 2020**, 
although less attention was given to that platform and the configuration had to be manually updated to use the built-in GPS device.
...
## Examples of in-flight appearance.
These images give an idea of the a few of the pages displayed during flight and the info box layout that appears depending on context (cruise/thermal/flarm).

### Thermal view.
This view appears automatically when thermalling.
![Alt text](images/thermal-view.jpg?raw=true "Thermal view")

### Cruise view.
This view appears automatically when cruising.
![Alt text](images/cruise-view.jpg?raw=true "Cruise view")

### Flarm view.
If you manually switch to the Flarm page, detected traffic is displayed. The name of the aircraft (MZ in this case), comes from a match 
in the *xcsoar-flarm.txt* file.
![Alt text](images/flarm-view.jpg?raw=true "Flarm view")
...
1. Download the zip file from https://github.com/tkforbes/XCSoarData/archive/tf.zip
